    ...
    <rules key="{ff2e9e05-fdad-47fa-9be3-1f80258083e9}">
      <rule description="Right side DMS labels" filter="&quot;direction&quot; ='x' and round(&quot;value&quot; * 60) %5 = 0" key="{ae30cf35-b7a4-46c4-8f39-6fd87b015a48}">
        <settings calloutType="simple">
          <text-style allowHtml="0" blendMode="0" capitalization="0" fieldName="with_variable('value', abs(&quot;value&quot;),&#xa;&#xa;concat(@value//1, '°\n',&#xa;round((@value-floor(@value))*60), '′'&#xa;&#xa;)&#xa;)" fontFamily="Nimbus Sans LINZ" fontItalic="0" fontKerning="1" fontLetterSpacing="0" fontSize="6" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontUnderline="0" fontWeight="400" fontWordSpacing="0" forcedBold="0" forcedItalic="0" isExpression="1" legendString="Aa" multilineHeight="0.69999999999999996" multilineHeightUnit="Percentage" namedStyle="Narrow" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" stretchFactor="100" tabStopDistance="80" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" tabStopDistanceUnit="Point" textColor="50,50,50,255,rgb:0.1960784,0.1960784,0.1960784,1" textOpacity="1" textOrientation="horizontal" useSubstitutions="0">
            <families/>
